...
<div class="phd-book-section">
  <div class="phd-book-container">
    <a href="/phd-thesis/" class="phd-book-link">
      <div class="phd-book">
        <div class="phd-front">
          <div class="phd-cover"></div>
        </div>
        <div class="phd-left-side">
        </div>
      </div>
    </a>
  </div>
  <div class="phd-book-description">
    <h3>From Insights to Impact: Actionable Interpretability for Neural Machine Translation</h3>
